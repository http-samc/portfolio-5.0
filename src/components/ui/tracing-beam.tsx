    ...
    >
      <div className="absolute top-3">
        <motion.div
          ...
          className="ml-[27px] hidden h-4 w-4 rounded-full border border-netural-200 shadow-sm lg:flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
      ...
      <div ref={contentRef} className="lg:ml-20">
        {children}
      </div>
    </motion.div>
  );
